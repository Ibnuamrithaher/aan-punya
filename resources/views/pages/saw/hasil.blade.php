        ...
        <div class="col-xl-12 col-lg-7">
            <div class="card shadow mb-4">
                ...
                <div
                    ...
                    <h6 class="m-0 font-weight-bold text-primary">Grafik Simple Aditif Wignets</h6>
                ...
                <div class="card-body">
                    <div class="chart-area">
                        <canvas id="myAreaChartHasil"></canvas>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered data-table" id="dataTable" cellspacing="0">
                    <h3 style="text-align: center">MATRIX AFINITAS</h1>
                    <tbody>
                ...
                <table class="table table-bordered data-table">
                    <h3 style="text-align: center">MATRIX R</h1>
                    <tbody>
                ...
                <br>
                <table class="table table-bordered data-table">
                    <h3 style="text-align: center">MATRIX HASIL</h1>
                    <thead>
                        <tr>
                            <th>No</th>
